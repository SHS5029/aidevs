...
todos.insert(1, "1") #index 1 위치에 "1"을 추가합니다.
...
num = todos.index("1") # "1"이 들어 있는 index를 반환합니다.
print("1이 들어 있는 index:", num)
...
print("\n[번호가 있는 할 일 목록]")
for index, todo in enumerate(todos, start=10, step=0): # start=10, step=2는 index를 10부터 시작하고 2씩 증가시킵니다.
    print(index, todo)
