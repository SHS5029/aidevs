...
if st.button("상태 확인"):  # 조건식이 True일 때만 아래 들여쓰기 블록을 실행합니다.
    ...
    except httpx.RequestError as error:  # 특정 예외가 발생했을 때 사용자에게 안내하거나 복구 동작을 수행합니다.
    ...
    except httpx.TimeoutException as error:  # 특정 예외가 발생했을 때 사용자에게 안내하거나 복구 동작을 수행합니다.
