...
MAX_AGENT_ROUNDS = 8
QUESTION = "부산에 있는 호텔 중 아무 곳이나 1박 예약해줘."
INSTRUCTIONS = (
    "당신은 여행 관련 AI agent 입니다. 질문을 완전히 해결하는 데 필요한 Tool을 모두 사용하세요"
    "각 기능은 MCP Server에서 제공하며, Tool 이름은 Server 이름과 Tool 이름을 '__'로 연결한 형태입니다."
    "hotel_id로 조회하세요. Tool 결과만 근거로 한국어 최종 답변을 작성하세요."
    "재질문을 하지않고 최종 답변까지 한 번에 작성하세요."
)
