"""호텔 예약을 제공하는 교육용 stdio MCP Server입니다."""
...
mcp = FastMCP(
    "hotel",
    instructions="호텔 예약을 제공하는 교육용 stdio MCP Server입니다.",
)
...
def book_hotel(hotel_id: str) -> dict:
    """호텔 검색 결과의 hotel_id로 해당 호텔을 예약합니다. 예약 성공 시 예약 상태와 숙박 일수, 총 가격을 반환합니다."""
    ...
    return {
        ...
        "status": "예약 완료",
        "days": 1,
        "total_price": 1 * hotel["price"],
        "source": "lab-hotel-booking-service",
    }
